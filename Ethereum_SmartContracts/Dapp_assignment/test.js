  ...
  it("Should set winners", function() {
    ...
    ***********/
    return auctionInstance.register({from: accounts[2]}).then(function(result) {
      ...
      ***********/
      assert.notEqual(result.receipt.status,'0x0000000000000000000000000000000000000000','Winner if item 0 is not acc 0');
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result.receipt.status,'0x0000000000000000000000000000000000000000','Winner if item 1 is not acc 0');
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result.receipt.status,'0x0000000000000000000000000000000000000000','Winner if item 2 is not acc 0');
    })
  });
});